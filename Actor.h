...
public:
    ...
    // expose inventory for save/load
    const std::vector<std::unique_ptr<Items>>& getInventory() const { return m_inventory; }
...
public:
    Enemy(int hp, int att, int def) : Actor(hp, att, def) {}
